...
export default class FilmCard extends React.Component{
    ...
    render (){
        ...
        const colorRate =rate? classNames({
        ...
        const genreData = genres.map(genreApi => genre_ids.some(id=> id === genreApi.id) ? <Tag className=" " key={genreApi.name}>{genreApi.name}</Tag>:null)
        return (
            ...
            <div className="film-card films-list__card">
                ...
                <Card >
                    <img alt="постер фильма" className="film-card__poster" src={poster_path ?`https://image.tmdb.org/t/p/w185/${poster_path}`: withoutPoster}/>
                    ...
                    <div className="film-card__descr">
                        ...
                        <Rate allowHalf count={10} className="film-card__rate" defaultValue={ rate} onChange={(value)=>this.postRate(id, value)}/>
